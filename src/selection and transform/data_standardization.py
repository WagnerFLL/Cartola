...
columns = ['rodada', 'atleta_id', 'clube_id', 'pontuacao', 'pontuacao_media', 'preco', 
           'preco_variacao', 'posicao', 'FS', 'PE', 'A', 'FT', 'FD', 'FF', 'G', 'I', 
...
scouts_2014 = fill_cumulative_data(scouts_2014)
scouts_2016 = fill_cumulative_data(scouts_2016)
